...
from qeeg.utils.exceptions import ValidationError
...
def validate_array(
    ...
    --------
    >>> import numpy as np
    >>> from qeeg.utils.validation import validate_array
...
def validate_frequency_bands(
    ...
    Examples
    --------
    >>> from qeeg.utils.validation import validate_frequency_bands
...
def validate_picks(
    ...
    --------
    >>> import mne
    >>> from qeeg.utils.validation import validate_picks
    >>> raw = mne.io.read_raw_edf("sample.edf", preload=True)
...
def input_validator(func: Callable) -> Callable:
    ...
    Examples
    --------
    >>> from qeeg.utils.validation import input_validator
    >>> @input_validator
