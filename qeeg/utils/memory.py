...
def process_in_chunks(
    ...
    **kwargs
    ...
    --------
    >>> import mne
    >>> from qeeg.utils.memory import process_in_chunks
    >>> from qeeg.analysis.spectral import compute_band_powers
...
def estimate_memory_usage(
    ...
    **kwargs
    ...
    --------
    >>> import mne
    >>> from qeeg.utils.memory import estimate_memory_usage
    >>> raw = mne.io.read_raw_edf("sample.edf", preload=True)
...
def check_memory_limit(
    ...
    Examples
    --------
    >>> from qeeg.utils.memory import estimate_memory_usage, check_memory_limit
    >>> import mne
    >>> raw = mne.io.read_raw_edf("sample.edf", preload=True)
    >>> memory_usage = estimate_memory_usage(raw, operation='filter')
...
def suggest_chunk_size(
    ...
    **kwargs
    ...
    --------
    >>> import mne
    >>> from qeeg.utils.memory import suggest_chunk_size
    >>> raw = mne.io.read_raw_edf("sample.edf", preload=True)
