"""
Logging module for the qeeg package.
...
def setup_logger(
    ...
    ----------
    name : str, optional
        Name of the logger, by default 'qeeg'
    level : int, optional
    ...
    Examples
    --------
    >>> from qeeg.utils.logging import setup_logger
...
def get_logger(name: str = 'qeeg') -> logging.Logger:
    """
