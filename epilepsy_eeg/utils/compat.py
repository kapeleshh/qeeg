...
with external dependencies used by the epilepsy_eeg package.
"""
...
def get_installed_version(package_name: str) -> Optional[str]:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.compat import get_installed_version
...
def check_version(
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.compat import check_version
...
def check_dependencies(
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.compat import check_dependencies
...
def get_mne_version() -> Optional[str]:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.compat import get_mne_version
...
def check_mne_version(min_version: str = '1.0.0') -> bool:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.compat import check_mne_version
...
def get_sklearn_version() -> Optional[str]:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.compat import get_sklearn_version
...
def check_sklearn_version(min_version: str = '0.24.0') -> bool:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.compat import check_sklearn_version
...
def print_dependency_status() -> None:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.compat import print_dependency_status
