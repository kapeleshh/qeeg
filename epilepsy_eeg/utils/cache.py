...
def get_cache_dir() -> str:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.cache import get_cache_dir
    >>> cache_dir = get_cache_dir()
    >>> print(cache_dir)
    """
    # Default cache directory is ~/.epilepsy_eeg_cache
    cache_dir = os.path.join(os.path.expanduser('~'), '.epilepsy_eeg_cache')
...
def clear_cache(older_than: Optional[float] = None) -> int:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.cache import clear_cache
...
def get_cache_size() -> Dict[str, Union[int, float]]:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.cache import get_cache_size
...
def cache_result(
    ...
    *,
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.cache import cache_result
    >>> @cache_result
...
def memoize(func: Callable) -> Callable:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.cache import memoize
    >>> @memoize
    ... def fibonacci(n):
    ...     if n <= 1:
    ...         return n
...
class LRUCache:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.cache import LRUCache
...
def lru_cache(
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.cache import lru_cache
