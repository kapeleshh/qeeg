...
def timeit(func: Callable) -> Callable:
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.benchmark import timeit
    >>> @timeit
    ... def slow_function():
    ...     import time
    ...     time.sleep(1)
...
def benchmark_function(
    ...
    **kwargs
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.benchmark import benchmark_function
    >>> def test_func(x):
    ...     return x ** 2
...
def plot_benchmark_results(
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.benchmark import benchmark_function, plot_benchmark_results
    >>> def func1(x):
    ...     return x ** 2
    >>> def func2(x):
    ...     return x ** 3
...
def compare_functions(
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.benchmark import compare_functions
    >>> def func1(x):
    ...     return x ** 2
    >>> def func2(x):
    ...     return x ** 3
...
def benchmark_preprocessing_pipeline(
    ...
    --------
    >>> import mne
    >>> from epilepsy_eeg.utils.benchmark import benchmark_preprocessing_pipeline
    >>> from epilepsy_eeg.preprocessing import filtering, artifacts
...
def benchmark_memory_usage(
    ...
    **kwargs
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.benchmark import benchmark_memory_usage
...
def create_benchmark_report(
    ...
    Examples
    --------
    >>> from epilepsy_eeg.utils.benchmark import benchmark_function, create_benchmark_report
    >>> def func1(x):
    ...     return x ** 2
    >>> def func2(x):
    ...     return x ** 3
